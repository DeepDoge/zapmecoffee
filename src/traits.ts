...
export type Enum<
	T extends Record<string, (...args: any) => { readonly type: string }>,
...
export type Dyn<T extends Trait> = {
	[K in keyof T]: T[K] extends (self: any, ...args: infer A) => infer R ? (...args: A) => R
		: T[K];
};
	...
	return new Proxy(impl, {
		get(target, prop, receiver) {
			...
			if (typeof value === "function") {
				return (...args: any[]) => value(instance, ...args);
			}
			return value;
		},
	}) as never;
